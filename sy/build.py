# -*- coding: utf-8 -*-
"""〈구래〉 빌드 — src/*.js (ES 모듈) 를 의존성 없는 단일 index.html 로 굽는다.
...
MODULES = [
    ...
    'world/data/names.js',
    'world/data/roads.js',
    'world/data/footprints.js',
    'world/data/ground.js',
    'world/data/landmarks.js',
    'world/data/npcs_extra.js',
    'world/data/npcs.js',
    'world/data/events_odd.js',
    'world/data/events.js',
    'game/data/items.js',
    'world/buildings.js',
    'world/map.js',
    'world/pathing.js',
    ...
    'ui/hud.js',
    'game/state.js',
    'game/data/encounters_city.js',
    'game/data/encounters_nature.js',
    'game/data/encounters_deep.js',
    'game/encounters.js',
    'game/endings.js',
    'game/gizmos.js',
    'ui/ending.js',
