...
`music/` 에는 **악기 교실** 이 들어 있습니다. 보컬·기타·베이스·건반·드럼 다섯 파트의
튜토리얼과 예시 악보에, 코드 사전·튜너·메트로놈이 붙어 있습니다. 코드 이름을 치면 세 악기에서
어디를 잡는지, 몇 개만 잡을 때 무엇을 남기고 무엇을 빼는지까지 보여 줍니다.
역시 `music/index.html` 하나로 돌아갑니다. 자세한 것은 `music/README.md` 를 보세요.
